...
def main():
    ...
    summary_template = """ Given the information {information} about the person tell about the person in two lines"""

    summary_prompt_tempalate = PromptTemplate(
    ...
    chain = summary_prompt_tempalate | llm
